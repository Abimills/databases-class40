...
.findOne({
  ...
  console.log(
    `The season and episode number of the "BLACK RIVER" episode is ${findMyEpisodeNum.episode}`
  );
...
console.log(
  `The episodes that Bob Ross painted a CLIFF and a LIGHTHOUSE are ${individualResult}`
);
}
...
async function updateEpisodeExercises(client) {
  ...
  console.log(
    `Ran a command to update all the BUSHES to BUSH and it updated ${adjustmentMadeToBushes.modifiedCount} episodes`
  );
}
