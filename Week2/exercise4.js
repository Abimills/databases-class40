...
con.query(`SELECT paper_title, COUNT( DISTINCT authors.author_name) AS 'number_of_authors'  FROM authors
...
con.query(`SELECT  COUNT( DISTINCT research_papers.paper_title) AS 'research_made_by_women'  FROM authors
...
con.query(`SELECT university,  COUNT( DISTINCT research_papers.paper_title) AS 'sum_of_research_papers'  FROM authors
...
con.query(`SELECT university, MIN(authors.h_index) AS 'MIN_h_index_per_university', MAX(authors.h_index) AS 'MAX_h_index_per_university'  FROM authors
